SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='harbor.kubernetes.day/supply-chain/chain/tanzu-java-web-app-source')
...
allow_k8s_contexts('gke_gcpjgoh-343516_asia-southeast1_gkecluster')
